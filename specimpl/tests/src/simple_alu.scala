...
object simple_alu extends TestSuite {
  ...
  def tests: Tests = Tests {
    test("CompleteSpec_MissingAdd") {
      check(() => new CompleteSpec_MissingAdd)==> false
    }
    test("CompleteSpec_Correct") {
      check(() => new CompleteSpec_Correct) ==> true
    }
    test("IncompleteSpec_AlwaysOutput") {
      check(() => new IncompleteSpec_AlwaysOutput) ==> false
    }
    test("IncompleteSpec_Correct") {
      check(() => new IncompleteSpec_Correct) ==> true
    }
    test("BufferedOutput_WrongAssign") {
      check(() => new BufferedOutput_WrongAssign) ==> false
    }
    test("BufferedOutput_Correct") {
      check(() => new BufferedOutput_Correct) ==> true
    }
  }
